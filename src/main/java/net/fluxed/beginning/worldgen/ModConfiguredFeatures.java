package net.fluxed.beginning.worldgen;
...
//                ModBlocks.BISMUTH_NETHER_ORE.get().defaultBlockState(), 9));
                register(context, SODIUM_ORE_KEY, Feature.ORE, new OreConfiguration(endReplaceables,
                ModBlocks.SODIUM_ORE.get().defaultBlockState(), 9));
...
//                        ), List.of(Blocks.GRASS_BLOCK)));
    ...
    public static ResourceKey<ConfiguredFeature<?, ?>> registerKey(String name) {
        return ResourceKey.create(Registries.CONFIGURED_FEATURE, Identifier.fromNamespaceAndPath(TheBeginning.MOD_ID, name));
    }
